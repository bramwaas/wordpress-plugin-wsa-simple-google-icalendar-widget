...
To make transform smoother: Add parseInt to all integers in transform in block.js.    
Solved a number of typos in dateformat_... in update function in widget.php
